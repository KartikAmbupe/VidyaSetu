...
export const DashboardHome: React.FC<{ onNavigate: (view: View) => void }> = ({ onNavigate }) => {
    ...
    const mainActivities = [
        ...
        { title: "Watch a Video", description: "Fun educational videos just for you", emoji: "📺", color: "bg-gradient-to-br from-red-400 via-pink-400 to-purple-500", hoverColor: "hover:from-red-300 hover:via-pink-300 hover:to-purple-400", size: "medium", view: 'child-home' },
